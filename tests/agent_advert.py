...
class agent_adv():
    ...
    def clear_syslogs(self):
        ...
        clear sys logs
        """
        subprocess.run(["rm tests/logs/agent_advert/vm1_syslog"], shell=True, capture_output=False)
        subprocess.run(["rm tests/logs/agent_advert/vm2_syslog"], shell=True, capture_output=False)
    ...
    def save_syslogs(self):
        ...
        subprocess.run(["mv tests/logs/agent_advert/syslog tests/logs/agent_advert/vm1_syslog"], shell=True, capture_output=False)
        scp.close()
